...
GRAPHRAG_PACKAGE_ROOT = Path(__file__).resolve().parents[1] / "graphrag"
if str(GRAPHRAG_PACKAGE_ROOT) not in sys.path:
...
from app.graphrag.graphrag.config.enums import IndexingMethod
from app.graphrag.graphrag.logger.rich_progress import RichProgressLogger
from app.graphrag.graphrag.index.typing.pipeline_run_result import PipelineRunResult
